...
Summary: 
The Sweet and Salty Console Application prints numbers to the console screen starting 
at a number specified by the user and stopping at a number specified by the user. 
...
Create a new repo for yourself in the batch org called fname-lname-challenges.
Clone this new repo and create a new branch called, CodeAssignment-fname-lname (ex. CodeAssignment-mark-moore)   
Create for your source code a directory titled, SweetSaltyChallenge Create a new .NET C# console application   
